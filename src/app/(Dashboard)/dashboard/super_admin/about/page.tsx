...
import { TAbout, TService } from "@/types";
import CreateAboutModal from "./_components/CreateAboutModal";
import UpdateAboutModal from "./_components/UpdateAboutModal";
import { useDeleteAboutMutation, useGetAllAboutQuery } from "@/redux/api/aboutApi";
...
const ServicePage = () => {
    ...
    const { data: aboutData, isLoading } = useGetAllAboutQuery({ page: currentPage, limit: 5 });
    ...
    const { meta, } = aboutData?.data || { meta: {}, oppresses: [] };
            ...
            <DashboardCard>
                <Box>
                    ...
                    <Box display='flex' justifyContent='space-between'>
                        <Typography variant="h5" fontWeight='bold'>Who We Are List </Typography>
                    ...
                    <Box bgcolor="white" padding={3}>
                        <TableContainer component={Paper}>
                            <Table aria-label="simple table">
                                ...
                                <TableBody>
                                    {aboutData?.data?.abouts?.map((data: TAbout, index: number) => (
                                        <TableRow
                                            key={data._id}
