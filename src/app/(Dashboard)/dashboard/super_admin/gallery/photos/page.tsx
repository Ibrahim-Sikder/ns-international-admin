...
const PhotosPage = () => {
  ...
  const { data: foldersData } = useGetFoldersQuery(undefined) as any;
  ...
  return (
    <PageContainer title="Manage your images here" description="Manage your images here">
        ...
        <Box>
          <Box display="flex" alignItems="center" justifyContent="space-between" gap={2} flexWrap="wrap">
            ...
            <Stack direction="row" spacing={2}>
              <Button variant="contained" color="primary" size="small" onClick={() => refetch()} startIcon={<Refresh />}>
                Refresh
              </Button>
          ...
          {isLoading || isFetching ? (
            ...
            <>
              ...
              <Pagination
                ...
                onChange={(event, page) => setParams([{ name: "page", value: page }])}
                sx={{ mt: 3 }}
              />
            </>
          ) : (
